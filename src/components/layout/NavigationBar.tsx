      ...
      `}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            {/* Admin Section - Only show on blog pages */}
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-xs text-purple-400">Edit and organize blog content</div>
                      </div>
                    </Link>
                    <Link
                      href="/blog/create"
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-xs text-green-400">Write and publish new content</div>
                      </div>
                    </Link>
                  </div>
                </div>
