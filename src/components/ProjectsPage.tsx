...
const ProjectsPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-blue-900 via-purple-900 to-black overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-purple-300">
                Explore my projects as interactive islands
              </p>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <QuickNavigation currentPage="projects" />

                <button
                  onClick={() => window.history.back()}
                  className="px-4 py-2 bg-gray-600/20 hover:bg-gray-600/40 text-white rounded-lg border border-gray-500/30 transition-colors"
                >
                  ← Back
                </button>
              </div>
      ...
      {/* Instructions Panel */}
      <motion.div
        className="absolute top-24 left-6 z-10 bg-black/40 backdrop-blur-sm rounded-lg p-4 max-w-xs"
      ...
      >
        ...
        <div className="space-y-2 text-sm text-gray-300">
          <div className="flex items-center gap-2">
            ...
            <span>Click islands to view details</span>
          </div>
          <div className="flex items-center gap-2">
      ...
      {/* Stats Panel */}
      <motion.div
        className="absolute bottom-6 left-6 z-10 bg-black/40 backdrop-blur-sm rounded-lg p-4"
        initial={{ y: 100, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div className="text-center">
            ...
            <div className="text-gray-300">Demos</div>
          </div>
        </div>
      </motion.div>
